...
function OrderHist(){
    ...
    <Link to ="/user/profile">
      ...
      <div className="w-11/12 h-4/6 mx-auto overflow-y-auto bg-white">

      <div className="w-full h-1/6 text-xl text-white text-center mx-auto overflow-y-auto bg-red-900">Order 1</div>
