...
<div class="w-3/4 h-3/4 mx-auto">
    ...
    <Link to="/user/settings/editprofile">
    <button href="#" type="button" class=" text-xl sm:text-2xl h-full w-full rounded-full  font-bold bg-gradient-to-r bg-orange-500 hover:from-orange-600 hover:to-rose-500 ">
  Edit Profile
    </button> 
    </Link>
  ...
  Change Password
    ...
    <Link to="/">
    <button type="button" class=" h-full w-full rounded-full text-xl sm:text-2xl font-bold bg-gradient-to-r bg-orange-500 hover:from-orange-600 hover:to-rose-500 "
    onClick={()=>alert("Successfully Signed Out")}>
  Sign Out
    </button>
   </Link>
    <div></div>

    <Link to="/user/settings/deletewarning">
    <button type="button" class=" h-full w-full text-xl sm:text-2xl font-bold rounded-full bg-red-700 hover:bg-red-900 text-white"
    >
  Delete Account
    </button>
     </Link>
